...
export const FAQ: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      ...
      'HTTPS. It deploys one node per stack, with no clustering or failover. Backup restore is not ' +
      'available on the current release line. Windows is supported through WSL2 rather than ' +
      'natively. And it manages the infrastructure OpenClaw runs on, not the agent itself.',
